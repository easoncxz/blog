...
When a subkey is revoked, its corresponding subkey and subkey certification is 
removed from the set of information contained within the GPG key in which it 
resided.
