...
about our thinking process is, that if we don't make a note of thoughts, they'll 
just slip away. In [*Anecdotes of maths 
...
**in a famous software company, you'll find a teddy bear on the each developer's 
desk. Before asking each other questions, everyone first iterates the question 
to the teddy bear to start with, to see whether he's able to clearly state the 
question. It endded up oftening being the case that once the question is clearly 
iterated, the answer just comes naturally.** Of course, you don't *have to* talk 
...
when I'm on the road. But if you're sitting down, I suggest that you give your 
words to an actual audience -- namely, write down your thinking, because 
[writing is better 
...
only fit few entries. (Remember that Flash minigame where you try to memorize as 
many as possible simultaneously flashing numbers on the screen?) [Most of the 
time our reasoning process is done 
...
corollaries. Try it our yourself: count the number of times you had a discussion 
with someone where you were thinking **"Well quite intuitive to me, that's 
obviously true. However if you ask me why, I wouldn't actually know what's going 
on in there."** **Doesn't it bother you? If not even yourself can support your 
own propositions using logic, how could you be so sure that it's indeed true?  
Simply because your hunch tells you so? Well then what happens if a person 
standing right next to you hold an opposite view on the matter, and *he* has a 
strong hunch that *he's* right? "His hunch is wrong, while my hunch is 
correct."? So you're really that confident of your intuition?**
...
during moments like these that you're deep in reflection. When you've dug to the 
roots, and seen the whole iceberg beneath the surface, you will have this grand 
sense of achievement and satisfaction for finally knowing how you knew what you 
know.
...
in our day-to-day life, you'll think that many things are "obvious"; but as soon 
as you need to explain it to someone, you'll immediately realise that the whole 
thing ain't so "obvious" afterall. As you try to explain, you'll find yourself 
using the word "anyway" before you notice.
...
hidden assumptions. **How would you know what has gone wrong, if you didn't know 
the reasoning your brain did before arriving at the conclusion?** On the other 
hand, once we figure out the process of reasoning we've gone through to get to 
the conclusion, we won't be too far away from finding the error in our thought 
process -- if a person who's debating with you only ever states his position, 
you'll find it hard to debat with him, whereas if he exposes to you the process 
of his reasoning, it'll be a much easier job to criticise. (And for the same 
reason, some people like to hide their reasoning behind their backs, rather than 
yanking them out.)
...
how these conclusions are reached, or what was going on behind the scenes of our 
thoughts. Hence when we discover that our conclusion is wrong, we're lost, not 
able to find the bug that caused it. If you pay close attention to peoples' 
...
assume that your reader is standing on floor 10, hoping that just by telling him 
what's there on floor 11 you'd be able to let him "get it". Your reader is 
...
explain stuff to someone who has *no idea at all* about your topic -- instead, 
we often end up explaining things to our peers in the same field. It's not true 
that in this case there's no more "reflection" -- you'll in fact realise that if 
you publicly discuss your ideas, you'll **most likely run into people who hold 
different or opposite opinions**, and **by comparing your view with his**, 
you'll realise that there are divergences right at the beginning of the streams 
of thoughts of the two of you. Now the natural question is: "where did this 
divergence come from?" **As the discussion between you two progesses deeper, 
you're each forced by each other to show deeper reasoning**. As opposed to 
"explaining to an outsider", this is also an effective way of encouraging 
...
habit of persistently learning and thinking, your blog will soon run out of 
...
blog will be discovered by others on the internet -- because lots of information 
aggregation platforms [TODO][TODO] are begging for valueable content like that. 
There are search engines to provide a vast possible audience to your content; 
there are people who are looking for and forwarding these meaningful content. 
**The worst decision we can make is to stop doing something that doesn't cause 
any harms, but does many goods.**
...
deduction" mode, and all unhappy emotions and frustration silently fades away.  
