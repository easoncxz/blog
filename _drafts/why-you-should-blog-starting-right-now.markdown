...
thing about our thinking process is, that if we don't make a note of thoughts,
they'll just slip away. In [*Anecdotes of maths
geniuses*](http://blog.csdn.net/fgs2008/article/details/570561) (honour belongs
to ukim), there's this story about Hilbert: Once in a seminar of Hilbert's, a
young man used an elegant theorem in his talk. Hilbert said, "This is a really
beautiful (wunderbaschon) theorem. Who discovered it?" The young man was
confused: "It's you, sir..."

**3) Teaching is the best learning.** [If you're not able to explain something
clearly, there's a fair chance you haven't actually mastered it.][TODO] You'll
likely have heard that in the software industry's interviews, the interviewer
often asks you to explain something to him, while saying that he/she "doesn't
know about it beforehand", and your job is to explain until he/she gets it.
(The effect is stronger when he/she *really* didn't know about the topic
beforehad.)
...
realising**, and move them from [Implicit Memory][TODO] to [Explicit
Memory][TODO]. Only a person who knows, **and knows that he knows**, all the
frames down the stack of abstraction, would be able to give [an explanation
that's crystal
...
what's so good about knowing which things you know? After all, I might not
bother making the effort unless I want to be a teacher.

[sagasw](http://sunxiunan.com/) on TopLanguage once told us this little story:
**in a famous software company, you'll find a teddy bear on the each
developer's desk. Before asking each other questions, everyone first iterates
the question to the teddy bear to start with, to see whether he's able to
clearly state the question. It endded up oftening being the case that once the
question is clearly iterated, the answer just comes naturally.** Of course, you
don't *have to* talk to the *teddy bear* -- you can simply imagine a person who
knows little about your topic, and try explaining stuff to him. This is
practicable; I often do so when I'm on the road. But if you're sitting down, I
suggest that you give your words to an actual audience -- namely, write down
your thinking, because [writing is better
...
only fit few entries. (Remember that Flash minigame where you try to memorize
as many as possible simultaneously flashing numbers on the screen?) [Most of
the time our reasoning process is done
automatically](http://www.douban.com/subject/1005576/), taking place in our
subconsciousness -- and we can only sense the existance of few intermidiate
corollaries. Try it our yourself: count the number of times you had a
discussion with someone where you were thinking **"Well quite intuitive to me,
that's obviously true. However if you ask me why, I wouldn't actually know
what's going on in there."** **Doesn't it bother you? If not even yourself can
support your own propositions using logic, how could you be so sure that it's
indeed true?  Simply because your hunch tells you so? Well then what happens if
a person standing right next to you hold an opposite view on the matter, and
*he* has a strong hunch that *he's* right? "His hunch is wrong, while my hunch
is correct."? So you're really that confident of your intuition?**
...
everywhere putting together all the pieces of the puzzle, questioning the
obvious, correcting false assumptions, and working it all out.** On the other
hand, moments when you think **"I really think there's something wrong about
this statement, but I don't know *what*."** are also extremely meaningful
moments, because they almost always mean that you're holding a certain bias,
having certain misunderstandings of the matter, unknowingly introduced an
underlying assumption, or swapped out an important concept etc. It's exactly
during moments like these that you're deep in reflection. When you've dug to
the roots, and seen the whole iceberg beneath the surface, you will have this
grand sense of achievement and satisfaction for finally knowing how you knew
what you know.
...
knowledge, and iterate it for your readers, you'll have found that you've
created those chances by yourself, for yourself**. If you don't reflect enough
in our day-to-day life, you'll think that many things are "obvious"; but as
soon as you need to explain it to someone, you'll immediately realise that the
whole thing ain't so "obvious" afterall. As you try to explain, you'll find
yourself using the word "anyway" before you notice.

And so the chance of reflection arose.

**As soon as you dig stuff out from the back of your mind, you have the chance
of direcly facing them and hence reflecting upon them, instead of letting them
steer your thoughts subconsciously.** Oftentimes when there's a problem in our
reasoning, it's not because we can't reflect, but because we don't know of our
hidden assumptions. **How would you know what has gone wrong, if you didn't
know the reasoning your brain did before arriving at the conclusion?** On the
other hand, once we figure out the process of reasoning we've gone through to
get to the conclusion, we won't be too far away from finding the error in our
thought process -- if a person who's debating with you only ever states his
position, you'll find it hard to debat with him, whereas if he exposes to you
the process of his reasoning, it'll be a much easier job to criticise. (And for
the same reason, some people like to hide their reasoning behind their backs,
rather than yanking them out.)

Most of the time [we reach conclusions without much thinking, like a wound-up
clockwork](http://book.douban.com/subject/1005576/), while we don't really know
how these conclusions are reached, or what was going on behind the scenes of
our thoughts. Hence when we discover that our conclusion is wrong, we're lost,
not able to find the bug that caused it. If you pay close attention to peoples'
sayings (blogs, forums etc.), and split their prose into "pre-condition",
"assumption", "proof", "conclusion", you'll soon realise that most of what most
people do is stating conclusions, declaring positions, with little trace of
pre-conditions, assumptions, and logic deduction. It's usually not that they
really aren't willing to write down their logic; it's just that reflecting on
one's own thought process is a really difficult thing to do. Too much of our
reasoning happen under the water -- only the bubbles of noteworthy conclusions
float to the surface, which we'll then be able to grasp. And this hasn't even
mentioned that we actually usually end up using a [thinking
shortcut](http://www.douban.com/subject/1005576/) instead of a proper, complete
chain of logic.

**To teach an oblivious is the strongest way to reflect** -- because he doesn't
have any preparative knowledge. In order to let him understand what you know,
you must completely decompose your tree of knowledge, figure out the foundation
on which this whole monument is build, where its load-bearing structures are,
and how it's laid out brick by brick. You can't just stand on floor 11, and
assume that your reader is standing on floor 10, hoping that just by telling
him what's there on floor 11 you'd be able to let him "get it". Your reader is
always standing on the ground floor. You have to know how all those 11 floors
beneath you are built. **It's this that requires you to perform a complete,
thorough re-examination of all that you've mastered, or all that you *thought*
was correct. The more innocent and oblivious your audience is, the deeper your
reflection would need to be.**

**4) Discussion is excellent reflection.** Sometimes we don't *actually* want
to explain stuff to someone who has *no idea at all* about your topic --
instead, we often end up explaining things to our peers in the same field. It's
not true that in this case there's no more "reflection" -- you'll in fact
realise that if you publicly discuss your ideas, you'll **most likely run into
people who hold different or opposite opinions**, and **by comparing your view
with his**, you'll realise that there are divergences right at the beginning of
the streams of thoughts of the two of you. Now the natural question is: "where
did this divergence come from?" **As the discussion between you two progesses
deeper, you're each forced by each other to show deeper reasoning**. As opposed
to "explaining to an outsider", this is also an effective way of encouraging
yourself to reflect. The deeper the discussion and questioning goes, the closer
you'll be from the essence of the issue, the more likely it'll be that you
discover hidden differences in thinking that you'll likely overlook otherwise.
**And so you'll have had another valueable chance to inspect your own knowledge
in seek of false information.**

**5) It encourages you to continue learning and thinking.** If you didn't have
a habit of persistently learning and thinking, your blog will soon run out of
things to write about, or just end up being a record of daily trivialities or
reposts of blog posts of others. Your readers would leave, and you'll end up
closing your blog, and then you'd also give up blogging altogether, then you'd
discover that there's now one less way of encouraging yourself to reflect and
learn, and then you'd be even less keen on reflecting and summarizing, and
then...

Don't get caught in this sort of vicious circle. Don't permanently stop
blogging. Even if you don't publish any posts for two or three months, as long
as every post in your blog is the outcome of your own meaningful thinking, your
blog will be discovered by others on the internet -- because lots of
information aggregation platforms [TODO][TODO] are begging for valueable
content like that.  There are search engines to provide a vast possible
audience to your content; there are people who are looking for and forwarding
these meaningful content.  **The worst decision we can make is to stop doing
something that doesn't cause any harms, but does many goods.**
...
independent opinions. This might seem like some upside-down logic, but it'll
make sense very soon. [TODO][TODO] 

**6) You can learn to do something persistently.** Lots of people feel lost in
life, not knowing what to do. This is because they didn't find a thing they can
keep on doing. In the words of Positive Psychology[TODO][TODO], these people
don't have things in which they can experience
...
especially true when it comes to writing rationally: the brain enters a
"logical deduction" mode, and all unhappy emotions and frustration silently
fades away.  But then again, the pre-condition of the whole thing is that you
*start* writing. After you've made it through [TODO][TODO] the most difficult
initial period, it will all just come naturally to you.
...
the **era of valueable blogs** -- most people are just re-blogging articles
from around the internet, or just posting smalltalk; hence the interviewer
wouldn't really take personal blogs as a serious, reliable means of knowing
about the applicant. Here, "CV" is a window through which others can get to
know you.  Although one might not be able to make one's blog a pillar of one's
career, like Yonghao Luo [TODO][TODO] or Keso (who made 5gme) has done, at
least **you can get to know more people because of blogging. The more valueable
your blog is, the more _capable_ [TODO][TODO] the people you get to know in
this way would be, and the more your knowledge horizon would extend, and then
you'll be able to grasp opportunities and jump to touch your goals, and then
you'll gradually become more _capable_ [TODO][TODO] yourself as well... This is
a virtuous cycle.**
...
skill". **Whether or not you're can be determined enough largely depends on
your methodology.**
...
people who're "smarter". We shouldn't reject recording our thoughts just
because there are "smarter" people out there; good understanding of a topic
always only comes after one's own thought. Besides, even if other people has
thought about a certain topic, there's always aspects of the topic that aren't
yet covered, thoughts people haven't thought. When putting thought into things
has become a habit, your ability to think and analyse things will steadily
grow, and your blog posts will become steadily more valueable. Let me repeat
this: **Whatever problem you're facing, must have been faced by others already.
Whatever comes out of your long and hard thinking will always be valueable to
many.**
...
aware, that problems always seem "simple" when you've already "got it". It's
not how difficult the problem seems in hindsight that matters -- it's **how
much process it requires you to go through before you can get from confused to
clear** that counts. The more time and effort it took you to make that
transition, the more people out there would we expect to not have done the
same.  The harder the task, the fewer the conquerors.
...
of the Gmail team and the founder of FriendFeed, and Jeff Atwood have
exclaimed: "Overnight success takes a long time."
